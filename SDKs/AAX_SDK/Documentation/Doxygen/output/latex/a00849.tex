\hypertarget{a00849}{}\doxysection{Page Table Guide}
\label{a00849}\index{Page Table Guide@{Page Table Guide}}
How to map a plug-\/in\textquotesingle{}s parameters to control surfaces. 

\hypertarget{a00849_aax_page_table_guide_contents}{}\doxysubsection{Contents}\label{a00849_aax_page_table_guide_contents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00849_aax_page_table_guide_01_introduction}{Introduction}} \item \mbox{\hyperlink{a00849_aax_page_table_guide_02_avid_control_surfaces}{Avid Control Surfaces}} \item \mbox{\hyperlink{a00849_aax_page_table_guide_03_plug_in_page_table_guidelines}{Plug-\/\+In Page Table Guidelines}} \item \mbox{\hyperlink{a00849_aax_page_table_guide_04_avid_center_section_page_tables}{Avid Center Section Page Tables}} \item \mbox{\hyperlink{a00849_aax_page_table_guide__eucon_page_tables}{EUCON Page Tables}} \item \mbox{\hyperlink{a00849_aax_page_table_guide_05_implementing_page_tables}{Implementing Page Tables}} \item \mbox{\hyperlink{a00849_aax_page_table_guide_a_get_parameter_value_info}{Appendix A. Get Parameter Value Info}}\end{DoxyItemize}
 \hypertarget{a00849_aax_page_table_guide_01_introduction}{}\doxysubsection{Introduction}\label{a00849_aax_page_table_guide_01_introduction}
 \hypertarget{a00849_subsection__control_surfaces_overview}{}\doxysubsubsection{Control Surfaces Overview}\label{a00849_subsection__control_surfaces_overview}
...
\hypertarget{a00849_subsection__page_tables_overview}{}\doxysubsubsection{Page Tables Overview}\label{a00849_subsection__page_tables_overview}
...
More concretely, a set of page tables is simply a set of single dimensional arrays. Each slot of the array corresponds to a particular rotary encoder or push-\/button of the control surface. By inserting control indices into the elements of the array, a plug-\/in\textquotesingle{}s controls are mapped to particular tangible controls of the CS. Page tables are stored as XML data created by the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} application available as part of the \mbox{\hyperlink{a00868}{AAX}} SDK Toolkit on the \href{https://my.avid.com/products/cppsdk}{\texttt{ My Toolkits and Downloads}} page at avid.\+com. The XML is referenced by the plug-\/in as a resource using a call to \mbox{\hyperlink{a02101_a3326bd8e29690a352408539029a50a61}{AAX\+\_\+\+IEffect\+Descriptor\+::\+Add\+Resource\+Info()}}.
...
The following sections describe the various interfaces that the supported control surfaces provide for modifying plug-\/in parameters. Later, the specifics of implementation of page tables is described. 
 ...
 \hypertarget{a00849_aax_page_table_guide_02_avid_control_surfaces}{}\doxysubsection{Avid Control Surfaces}\label{a00849_aax_page_table_guide_02_avid_control_surfaces}
\hypertarget{a00849_subsection__eucon}{}\doxysubsubsection{EUCON}\label{a00849_subsection__eucon}
\hypertarget{a00849_subsubsection__avid_ptcontrol}{}\doxyparagraph{Pro Tools $\vert$ Control app and Pro Tools $\vert$ Dock}\label{a00849_subsubsection__avid_ptcontrol}
The free Pro Tools $\vert$ Control app provides a EUCON-\/enabled control surface for i\+Pad. Combining Pro Tools $\vert$ Control with Pro Tools $\vert$ S3, Pro Tools $\vert$ Dock, or Artist Mix hardware adds additional touch workflows and custom control.   Pro Tools $\vert$ Control app display controlling an EQ plug-\/in instance 
...
When laying out plug-\/in parameters on its display, Pro Tools $\vert$ Control uses the same page table layotus as \mbox{\hyperlink{a00849_subsubsection__avid_artist_series_mc_control_v2_}{Artist Control}}

\hypertarget{a00849_subsubsection__avid_s6}{}\doxyparagraph{Pro Tools $\vert$ S6}\label{a00849_subsubsection__avid_s6}
Pro Tools $\vert$ S6 is a modular control surface solution for the most demanding audio mixing and production environments. Built on the same proven technology that is core to the industry-\/leading ICON and System 5 product families, S6 enables mixers to quickly turn around complex projects while swiftly handling last-\/minute changes. With its unparalleled ability to simultaneously control multiple Pro Tools and other EUCON-\/enabled DAWs over simple Ethernet, S6 also speeds workflows and enables network collaboration on a single integrated platform.   Pro Tools $\vert$ S6 

The main touch screen display on S6 can be configured to show graphs representing a plug-\/in\textquotesingle{}s frequency or dynamics response curves. To support this feature, a plug-\/in must implement \mbox{\hyperlink{a00827_gaa85bda4027342eb644a9c92a17da6d49}{AAX\+\_\+\+IEffect\+Parameters\+::\+Get\+Curve\+Data()}} for the applicable \mbox{\hyperlink{a00827_ga59c73d8f51c5c55d54a728eff39da884}{AAX\+\_\+\+ECurve\+Type}} selector.

\hypertarget{a00849_subsubsection__avid_s3}{}\doxyparagraph{Pro Tools $\vert$ S3}\label{a00849_subsubsection__avid_s3}
Pro Tools $\vert$ S3 is a compact, EUCON-\/enabled, ergonomic desktop control surface that offers a streamlined yet versatile mixing solution for the modern sound engineer. Like S6, S3 delivers intelligent control over every aspect of Pro Tools and other DAWs, but at a more affordable price. While its small form factor makes it ideal for space-\/confined or on-\/the-\/go music and post mixing, it packs enormous power and accelerated mixing efficiency for faster turnarounds, making it the perfect fit everywhere, from project studios to the largest, most demanding facilities.   Pro Tools $\vert$ S3 
...
\hypertarget{a00849_subsubsection__avid_artist_series_mc_control_v2_}{}\doxyparagraph{Avid Artist Series\+: Artist Control}\label{a00849_subsubsection__avid_artist_series_mc_control_v2_}
...
\hypertarget{a00849_subsubsection__avid_pro_series_mc_pro_}{}\doxyparagraph{Avid Pro Series\+: MC Pro}\label{a00849_subsubsection__avid_pro_series_mc_pro_}
...
The plug-\/in editing section consists of 8 pairs of touch-\/sensitive rotary knobs and switches. The rotary knobs are equipped with LED display rings that are available for control of EQ, Dynamics or any type of control your plug-\/in may need. As with the Artist Control, plug-\/in parameters can be mapped with the EUCON {\ttfamily Av81} page table or by the Pro\+Control or D-\/\+Control page tables described below. The 8 knobs are placed as two vertical groups of 4, laid out on the left half of the control surface, and are numbered top to bottom, left to right. \hypertarget{a00849_subsection__avid_c24_and_icon}{}\doxysubsubsection{Avid C$\vert$24 and ICON}\label{a00849_subsection__avid_c24_and_icon}
 \hypertarget{a00849_subsubsection__c24_}{}\doxyparagraph{C$\vert$24}\label{a00849_subsubsection__c24_}
...
\hypertarget{a00849_subsubsection__icon_dcontrol_es_}{}\doxyparagraph{ICON\+: D-\/\+Control ES}\label{a00849_subsubsection__icon_dcontrol_es_}
...
\hypertarget{a00849_subsubsection__icon_dcommand_es_}{}\doxyparagraph{ICON\+: D-\/\+Command ES}\label{a00849_subsubsection__icon_dcommand_es_}
...
S6L uses the same modular components as \mbox{\hyperlink{a00849_subsubsection__avid_s6}{Pro Tools $\vert$ S6}}, but uses a different set of encoder layouts on these components in order to best support mixing workflows in a live sound setting. When displaying plug-\/in parameters, S6L maps the parameters onto its CKM. The leftmost two columns on the CKM are reserved (one column for constant operations, one as a \char`\"{}spacer\char`\"{} row with not assignments), leaving six columns of knob cells available for plug-\/in parameters. S6L uses the {\ttfamily \textquotesingle{}Av46\textquotesingle{}} 4x6 page table type to map plug-\/in parameters to the CKM knob cells in this mode.
...
\hypertarget{a00849_subsubsection__venue_s3l}{}\doxyparagraph{VENUE $\vert$ S3\+L-\/X}\label{a00849_subsubsection__venue_s3l}
The VENUE $\vert$ S3\+L-\/X System is a modular live sound solution including an HDX-\/powered processing engine, scalable remote I/O, and an \mbox{\hyperlink{a00849_subsubsection__avid_s3}{S3}} control surface   VENUE $\vert$ S3\+L-\/X System 

When used as part of an S3L system, the top-\/right eight encoder/\+OLED pairs on the S3 control surface (the Global Control encoders) may be placed into Insert mode in order to map to any plug-\/in instance. When in Insert Mode, the Global Control encoders use the plug-\/in\textquotesingle{}s {\ttfamily \textquotesingle{}Pc\+TL\textquotesingle{}} page tables to map parameters onto the surface encoders.

Like S6L, S3L also includes support for dedicated EQ and dynamics plug-\/ins\+: a user can select a particular plug-\/in as his EQ or dynamics processor and use the surface\textquotesingle{}s EQ, Compressor/\+Limiter, and Expander/\+Gate selectors to bring up the plug-\/in on the top-\/left eight encoder/\+OLED pairs on the S3 (the Channel Control encoders.) This mode uses the plug-\/in\textquotesingle{}s D-\/\+Control Center Section EQ or Dynamics page tables when mapping plug-\/in controls. In order to be selectable as the system\textquotesingle{}s EQ or dynamics processor a plug-\/in must meet the criteria for an ICON center-\/section plug-\/in. See \mbox{\hyperlink{a00865_aax_venue_guide__systems__s3l__using_channel_control}{Using Channel Control}} in the \mbox{\hyperlink{a00865}{VENUE Guide}} and also \mbox{\hyperlink{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping}{Center Section Parameter Mapping on VENUE $\vert$ S3\+L-\/X}} below for more information about encoder mapping in Channel Control mode.



 \hypertarget{a00849_aax_page_table_guide_03_plug_in_page_table_guidelines}{}\doxysubsection{Plug-\/\+In Page Table Guidelines}\label{a00849_aax_page_table_guide_03_plug_in_page_table_guidelines}
...
\hypertarget{a00849_subsection__general_guidelines}{}\doxysubsubsection{General Guidelines}\label{a00849_subsection__general_guidelines}
...
\doxysubparagraph*{Repeat control parameters on pages where it makes sense to do so.}
 ...
 \hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables}{}\doxysubsection{Avid Center Section Page Tables}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables}
...
\cellcolor{\tableheadbgcolor}\textbf{ Table type }&\cellcolor{\tableheadbgcolor}\textbf{ Plug-\/in category  }\\\cline{1-2}
\endhead
{\ttfamily \textquotesingle{}Dg\+EQ\textquotesingle{}} &\mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4aad84edabff7d1d8732079b467c07dedcc}{EQ}}  \\\cline{1-2}
{\ttfamily \textquotesingle{}Dg\+CP\textquotesingle{}} &Compressor/\+Limiter (\mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4aa1e8d5202983c58aa0346a9a547f55bd9}{Dynamics}})  \\\cline{1-2}
{\ttfamily \textquotesingle{}Dg\+GT\textquotesingle{}} &Expander/\+Gate (\mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4aa1e8d5202983c58aa0346a9a547f55bd9}{Dynamics}})  \\\cline{1-2}
\end{longtabu}
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines}{}\doxysubsubsection{Center Section Page Table Guidelines}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines}
...
\end{DoxyNote}
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines_eq}{}\doxyparagraph{EQ Center Section Page Table Guidelines}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines_eq}
...
\begin{DoxyNote}{Note}
In order to use the \char`\"{}\+Q/\+Slope alternate parameter\char`\"{} functions in the EQ page table, a plug-\/in must respond to the \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a1a0d975a333d3aee81b22f878697e9c4}{AAX\+\_\+e\+Page\+Table\+\_\+\+Use\+Alternate\+Control}} selector in the \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} method. When the band type is changed, the control surface will call into the plug-\/in with this selector to determine if the control in the \char`\"{}\+Alt\char`\"{} position should be used. Please see the discussion of the \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} below.
\end{DoxyNote}
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines_dyn}{}\doxyparagraph{Dynamics Center Section Page Table Guidelines}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_guidelines_dyn}
...
The compressor/limiter page table, Dg\+CP, supports all the controls above except Range, Hysteresis, and Hold. (As you create the page table in the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}}, this is clear.)
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping}{}\doxysubsubsection{Center Section Parameter Mapping to Single-\/\+Column/\+Row Layouts}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping}
...
\end{DoxyNote}
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgEQ}{}\doxyparagraph{\textquotesingle{}\+Dg\+EQ\textquotesingle{} Page\+Table -\/ Equalizer}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgEQ}
 \tabulinesep=1mm
...
\item The knob assignments marked with an asterisk will be assigned depending on the plug-\/in\textquotesingle{}s response to \mbox{\hyperlink{a01953_a1702de6d62b5b41b6a8b2f510300392b}{AAX\+\_\+\+IEffect\+Parameters\+::\+Get\+Parameter\+Value\+Info()}} with the \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a1a0d975a333d3aee81b22f878697e9c4}{AAX\+\_\+e\+Page\+Table\+\_\+\+Use\+Alternate\+Control}} selector. If the plug-\/in provides \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29aa63097dc0b27e51411f30b06b2db26f1}{AAX\+\_\+e\+Use\+Alternate\+Control\+\_\+\+Yes}} then the assignment marked with an asterisk will be used.  
\end{DoxyItemize}

\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgCPDgGT}{}\doxyparagraph{Both \textquotesingle{}\+Dg\+CP\textquotesingle{} and \textquotesingle{}\+Dg\+GT\textquotesingle{} Page\+Tables -\/ Multi-\/dynamics}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgCPDgGT}
...
\begin{DoxyNote}{Note}
Some control surfaces may only partially follow this mapping. For example, the mapping of the Artist Mix control surface in Dyn mode uses two pages\+: it follows this mapping for encoder cells 1-\/8 on the first page and follows the \mbox{\hyperlink{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgCP}{\textquotesingle{}Dg\+CP\textquotesingle{}-\/only mapping}} for encoder cells 9-\/16 on the second page.
\end{DoxyNote}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{18}{|X[-1]}|}
\hline
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgCP}{}\doxyparagraph{\textquotesingle{}\+Dg\+CP\textquotesingle{} Page\+Table -\/ Compressor/\+Limiter}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgCP}
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgGT}{}\doxyparagraph{\textquotesingle{}\+Dg\+GT\textquotesingle{} Page\+Table -\/ Expander/\+Gate}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_eucon_mapping_DgGT}
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping}{}\doxysubsubsection{Center Section Parameter Mapping in S6 Expand Mode}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping}
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping_DgEQ}{}\doxyparagraph{\textquotesingle{}\+Dg\+EQ\textquotesingle{} Page\+Table -\/ Equalizer}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping_DgEQ}
   EQ layout in S6 Expand Mode

\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping_DgCP_DgGT}{}\doxyparagraph{\textquotesingle{}\+Dg\+CP\textquotesingle{} and \textquotesingle{}\+Dg\+GT\textquotesingle{} Page\+Tables -\/ Compressor/\+Limiter and Expander/\+Gate}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s6_mapping_DgCP_DgGT}
   Dynamics layout in S6 Expand Mode

\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping}{}\doxysubsubsection{Center Section Parameter Mapping on VENUE $\vert$ S3\+L-\/X}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping}
 Built-\/in processing parameters are mapped to the Channel Control encoders on VENUE $\vert$ S3L. For more information about Channel Control mode in S3\+L-\/X see \mbox{\hyperlink{a00865_aax_venue_guide__systems__s3l__using_channel_control}{Using Channel Control}} in the \mbox{\hyperlink{a00865}{VENUE Guide}}.

\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping_DgEQ}{}\doxyparagraph{\textquotesingle{}\+Dg\+EQ\textquotesingle{} Page\+Table -\/ Equalizer}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping_DgEQ}
 \tabulinesep=1mm
...
\hypertarget{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping_DgCP_DgGT}{}\doxyparagraph{\textquotesingle{}\+Dg\+CP\textquotesingle{} and \textquotesingle{}\+Dg\+GT\textquotesingle{} Page\+Tables -\/ Compressor/\+Limiter and Expander/\+Gate}\label{a00849_aax_page_table_guide_04_avid_center_section_page_tables_venue_s3l_mapping_DgCP_DgGT}
 \tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{4}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Channel Control~\newline
...
\hypertarget{a00849_aax_page_table_guide__eucon_page_tables}{}\doxysubsection{EUCON Page Tables}\label{a00849_aax_page_table_guide__eucon_page_tables}
...
\item[\mbox{\hyperlink{a00801__compatibility_notes000009}{Host Compatibility Notes}}]Pro Tools versions prior to Pro Tools 11.\+1 use plug-\/ins\textquotesingle{} Pro\+Control and ICON page tables (Dynamics, EQ, Channel Strip, Custom Fader, etc.) to map plug-\/in parameters to EUCON-\/enabled surfaces, so be sure that your plug-\/ins also implement these page tables correctly so that users with earlier versions of Pro Tools can have the best possible experience when using your plug-\/ins.\end{DoxyRefDesc}


\begin{DoxyNote}{Note}
The legacy Pe\+TE editor will remove all EUCON sections from any page table XML file that it saves. Developers should no longer use Pe\+TE for \mbox{\hyperlink{a00868}{AAX}} page table editing. If you do use Pete, it is important to {\itshape always back up your page table file} before editing the file in Pe\+TE.
\end{DoxyNote}
\hypertarget{a00849_subsection_eucon_page_tables_specification}{}\doxysubsubsection{Specification}\label{a00849_subsection_eucon_page_tables_specification}
...
\hypertarget{a00849_subsection_eucon_page_tables_types}{}\doxysubsubsection{Types}\label{a00849_subsection_eucon_page_tables_types}
 \tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{4}{|X[-1]}|}
\hline
...
\hypertarget{a00849_subsection_eucon_page_tables_conventions}{}\doxysubsubsection{Conventions}\label{a00849_subsection_eucon_page_tables_conventions}
...
\hypertarget{a00849_subsection_eucon_page_tables_requirements}{}\doxysubsubsection{Requirements}\label{a00849_subsection_eucon_page_tables_requirements}
...
\end{DoxyItemize}
 ...
 \hypertarget{a00849_aax_page_table_guide_05_implementing_page_tables}{}\doxysubsection{Implementing Page Tables}\label{a00849_aax_page_table_guide_05_implementing_page_tables}
\hypertarget{a00849_subsection_page_table_xml_specification}{}\doxysubsubsection{Page table XML specification}\label{a00849_subsection_page_table_xml_specification}
This section includes a rough specification for plug-\/in page table XML. Whenever possible, we encourage developers to use the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} tool to generate plug-\/in page tables rather than writing or editing the page table XML by hand.

The page table XML format contains three main tags\+:


\begin{DoxyItemize}
\item \mbox{\hyperlink{a00849_subsubsection_pagetablelayouts_tag}{Page\+Table\+Layouts tag}}
\item \mbox{\hyperlink{a00849_subsubsection_controlnamesvariations_tag}{Control\+Name\+Variations tag}}
\item \mbox{\hyperlink{a00849_subsubsection_editor_tag}{Editor tag}}
\end{DoxyItemize}

\hypertarget{a00849_subsubsection_pagetablelayouts_tag}{}\doxyparagraph{Page\+Table\+Layouts tag}\label{a00849_subsubsection_pagetablelayouts_tag}
...
\begin{DoxyEnumerate}
\item The {\ttfamily Desc} sub-\/element provides a brief description of the plug-\/in Type. This information is used only by the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} application and does not affect operation of the plug-\/in in Pro Tools.  
...
\hypertarget{a00849_subsubsection_controlnamesvariations_tag}{}\doxyparagraph{Control\+Name\+Variations tag}\label{a00849_subsubsection_controlnamesvariations_tag}
...
The identifiers for all parameters in the page table must and should match the IDs used for the control both in the $<$Page\+Table\+Layouts$>$ layouts and in the {\ttfamily Editor} tag\textquotesingle{}s {\ttfamily Disc\+Ctrls} sub-\/tag (see below). See \mbox{\hyperlink{a00849_subsection_parameter_identifiers}{Parameter identifiers}} for more information about parameter identifiers.
...
\hypertarget{a00849_subsubsection_editor_tag}{}\doxyparagraph{Editor tag}\label{a00849_subsubsection_editor_tag}
The last of the three main sections in an XML plug-\/in page table is the {\ttfamily Editor} section. This section is used by the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} application and you should not need to modify its contents. However, if you are encountering problems modifying your plug-\/in in the Page Table Editor then you may wish to verify that all plug-\/ins and controls are properly identified within the {\ttfamily Plugin\+List} and {\ttfamily Disc\+Ctrls} sub-\/tabs, respectively. Here is the {\ttfamily Editor} section from the Eleven page table XML\+:
...
\hypertarget{a00849_subsection_parameter_identifiers}{}\doxysubsubsection{Parameter identifiers}\label{a00849_subsection_parameter_identifiers}
 The {\ttfamily ID} tags/arguments in a page table must reference parameters which are exposed by the plug-\/in\textquotesingle{}s \mbox{\hyperlink{a02113}{AAX\+\_\+\+IEffect\+Parameters}} implementation via methods such as \mbox{\hyperlink{a01953_aff1ff6b27973200429f057dc003f30a8}{Get\+Parameter\+Index()}}.
...
\hypertarget{a00849_subsection_creating_page_tables_in_pete}{}\doxysubsubsection{Creating page tables using the AAX Plug-\/\+In Page Table Editor}\label{a00849_subsection_creating_page_tables_in_pete}
...
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_ManufactureID =\textcolor{stringliteral}{'AVID '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_ProductID = \textcolor{stringliteral}{'DmDE '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_TypeID\_AS = \textcolor{stringliteral}{'DmAS '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_TypeID\_MonoNative = \textcolor{stringliteral}{'DmRT '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_TypeID\_StereoNative = \textcolor{stringliteral}{'DsRT '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_TypeID\_MonoTI = \textcolor{stringliteral}{'DDT1 '};}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{a00404_ac678f9c1fbcc26315d209f71a147a175}{AAX\_CTypeID}} cDemoDist\_TypeID\_StereoTI = \textcolor{stringliteral}{'DDT2 '}; }
...
\begin{DoxyNote}{Note}
For compatibility between your AAX and corresponding RTAS or TDM plug-\/ins, make sure the 4 character IDs for \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da996465cca29a2a15291d1c788ac5728c}{AAX\+\_\+e\+Property\+\_\+\+Manufacturer\+ID}}, \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da3a41fcdff5af1a4fd19dcbca7b1ba6f3}{AAX\+\_\+e\+Property\+\_\+\+Product\+ID}}, \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da89ca3dd6e96895cda14976c1b1ceb826}{AAX\+\_\+e\+Property\+\_\+\+Plug\+In\+ID\+\_\+\+Native}}, and \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0dad3344696b8298a8b254add3d039ea927}{AAX\+\_\+e\+Property\+\_\+\+Plug\+In\+ID\+\_\+\+Audio\+Suite}} are identical to the legacy SDK\textquotesingle{}s counterpart.
\end{DoxyNote}
For more information about the AAX Plug-\/\+In Page Table Editor tool, see the Read\+Me file which accompanies the application.

\hypertarget{a00849_verifying_page_table_layouts_the_hidden_popup_menu}{}\doxysubsubsection{Verifying Page Table Layouts\+: The Hidden Pop-\/\+Up Menu}\label{a00849_verifying_page_table_layouts_the_hidden_popup_menu}
...
Sets the number of characters to be displayed in the control\textquotesingle{}s name (shown in the Page menu below). The identifier \char`\"{}expected length\char`\"{} appears next to lengths that should be specifically addressed (3, 4, 5, 6, 7, 8, and 31). If you use the XML page table system, the names can be specified in the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} application. Otherwise, the function Get\+Control\+Name\+Of\+Length() is responsible for providing names with these lengths.
...
\hypertarget{a00849_subsection_control_highlighting_scheme}{}\doxysubsubsection{Control Highlighting Scheme}\label{a00849_subsection_control_highlighting_scheme}
...
\hypertarget{a00849_subsection_control_numbering_layouts}{}\doxysubsubsection{Control Numbering Layouts}\label{a00849_subsection_control_numbering_layouts}
...
\hypertarget{a00849_subsection_alphanumeric_displays}{}\doxysubsubsection{Alphanumeric Displays}\label{a00849_subsection_alphanumeric_displays}
...
\hypertarget{a00849_subsection_procontrol_display}{}\doxysubsubsection{Pro\+Control Display}\label{a00849_subsection_procontrol_display}
...
Let\textquotesingle{}s take a moment to explain how the displays of C$\vert$24 and 003 work. Both of these surfaces have a four character LED display located above each encoder/switch pair. When in Channel mode, these scribble strips show the plug-\/in name (if any) on that channel. When that plug-\/in is selected, the display switches to show the controls for the plug-\/in. Now each display shows the name of the control. The display automatically switches to the current value of the control when the encoder or switch is moved or pushed. 
 ...
 \hypertarget{a00849_aax_page_table_guide_a_get_parameter_value_info}{}\doxysubsection{Appendix A. Get Parameter Value Info}\label{a00849_aax_page_table_guide_a_get_parameter_value_info}
\hypertarget{a00849_subsection__overview}{}\doxysubsubsection{Overview}\label{a00849_subsection__overview}
{\ttfamily AAX\+\_\+\+Result Get\+Parameter\+Value\+Info ( AAX\+\_\+\+CParam\+ID i\+Parameter\+ID, int32\+\_\+t i\+Selector, int32\+\_\+t$\ast$ o\+Value)}

\mbox{\hyperlink{a01953_a1702de6d62b5b41b6a8b2f510300392b}{Get\+Parameter\+Value\+Info()}} is implemented at the Data Model\textquotesingle{}s \mbox{\hyperlink{a01761}{AAX\+\_\+\+CEffect\+Parameters}} level, and will allow the app to query a plug-\/in for the \char`\"{}meaning\char`\"{} of its parameter values. It was designed as a general purpose mechanism that will find additional uses with new selectors in the future. It is used\+: 
\begin{DoxyItemize}
...
\hypertarget{a00849_subsection__implementation}{}\doxysubsubsection{Implementation}\label{a00849_subsection__implementation}
\mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} will be of type \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608}{AAX\+\_\+\+EParameter\+Value\+Info\+Selector}} (\mbox{\hyperlink{a00503}{AAX\+\_\+\+Enums.\+h}}) and will allow for future queries on parameter value \char`\"{}meaning.\char`\"{}


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum} \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608}{AAX\_EParameterValueInfoSelector}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a99ca84cc3dae0f125082d36893a12bcd}{AAX\_ePageTable\_EQ\_Band\_Type}} = 0,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608ac5a06a293b7706191d3371813c47e999}{AAX\_ePageTable\_EQ\_InCircuitPolarity}} = 1,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a1a0d975a333d3aee81b22f878697e9c4}{AAX\_ePageTable\_UseAlternateControl}} = 2}
\DoxyCodeLine{\}; }

\end{DoxyCode}
  Listing 3\+: Parameter Selector Enums

Results (not return values) passed back by \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} will be of one of these two types\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum} \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95}{AAX\_EEQBandTypes}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a7827eec27ad12a8abb7f466c629b6482}{AAX\_eEQBandType\_HighPass}} = 0,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a3dbff637a879e2f187f9ad1bbb97c8a3}{AAX\_eEQBandType\_LowShelf}} = 1,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a162d60d2812f3786ef5f87d288193e95}{AAX\_eEQBandType\_Parametric}} = 2,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95aa36c45b5f1a3dd677fdb14020b83d16f}{AAX\_eEQBandType\_HighShelf}} = 3,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a5de1272a9829d9d764a7a25adcdae1eb}{AAX\_eEQBandType\_LowPass}} = 4,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a5e8aee84ee2cd1db292283e7550e64dc}{AAX\_eEQBandType\_Notch}} = 5}
\DoxyCodeLine{\}; }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum} \mbox{\hyperlink{a00503_ab5bda96f09874705e9b800d1b1495b48}{AAX\_EEQInCircuitPolarity}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_ab5bda96f09874705e9b800d1b1495b48aa1f21f2aa320ece14a9259195d3ee2bd}{AAX\_eEQInCircuitPolarity\_Enabled}} = 0,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_ab5bda96f09874705e9b800d1b1495b48aeef37a6376396f07977b4c233985dfe6}{AAX\_eEQInCircuitPolarity\_Bypassed}} = 1,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_ab5bda96f09874705e9b800d1b1495b48a4a85b608d03de4997616de1e95610208}{AAX\_eEQInCircuitPolarity\_Disabled}} = 2}
\DoxyCodeLine{\}; }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum} \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29}{AAX\_EUseAlternateControl}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29a5cfea068cc7ea51becccc9d26955e443}{AAX\_eUseAlternateControl\_No}} = 0,}
\DoxyCodeLine{    \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29aa63097dc0b27e51411f30b06b2db26f1}{AAX\_eUseAlternateControl\_Yes}} = 1}
\DoxyCodeLine{\};  }

\end{DoxyCode}
  Listing 6\+: Alternate Control Enum

Please see \mbox{\hyperlink{a00503}{AAX\+\_\+\+Enums.\+h}} for more information.

To add support for this method, you must to override \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{AAX\+\_\+\+CEffect\+Parameters\+::\+Get\+Parameter\+Value\+Info()}} from within your plug-\/ins Data Model. For a given \mbox{\hyperlink{a00404_a1440c756fe5cb158b78193b2fc1780d1}{AAX\+\_\+\+CParam\+ID}}, selector, and parameter value, you must pass back a result (not a return value) denoting the \char`\"{}meaning\char`\"{} of that parameter value. If a parameter has no meaning in the context of the given selector, you should return \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\+\_\+\+ERROR\+\_\+\+UNIMPLEMENTED}}.

One point to note, is that an EQ or Dynamics plug-\/in may have a band of EQ that does not include an EQ type selector control. The band is just always, say, a HPF. There\textquotesingle{}s no control to map to the EQ type selector button in the page table and therefore no obvious control for which you would pass back \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a7827eec27ad12a8abb7f466c629b6482}{AAX\+\_\+e\+EQBand\+Type\+\_\+\+High\+Pass}} in \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}}. What is the solution? Well, the other controls on that band (Frequency, Q/\+Slope, Gain, In) know what type of band they\textquotesingle{}re on. Thus the plug-\/in should pass back the relevant EEQ\+\_\+\+Band\+\_\+\+Types enum in \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} for all controls on a given band of EQ. This also applies to key filter bands in your Dynamics plug-\/ins. In this way, the EQ type selector LEDs in both the EQ and Dynamics sections will always light appropriately.

The second exception applies to EQ or Dynamics plug-\/ins that have a band of EQ that does not include an In Circuit / Out of Circuit control for that band. In this case, the band is always In Circuit (or On) and the other controls for this band should return \mbox{\hyperlink{a00503_ab5bda96f09874705e9b800d1b1495b48aa1f21f2aa320ece14a9259195d3ee2bd}{AAX\+\_\+e\+EQIn\+Circuit\+Polarity\+\_\+\+Enabled}} as the result for \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} when the \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608ac5a06a293b7706191d3371813c47e999}{AAX\+\_\+e\+Page\+Table\+\_\+\+EQ\+\_\+\+In\+Circuit\+Polarity}} selector is passed in. Code snippets for \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} from the EQ III 7-\/Band AAX plug-\/in is provided below\+:
...
\DoxyCodeLine{\textcolor{comment}{// *************************************************}}
\DoxyCodeLine{\mbox{\hyperlink{a00404_a4d8f69a697df7f70c3a8e9b8ee130d2f}{AAX\_Result}} EQIII\_7\_Parameters::GetParameterValueInfo ( \mbox{\hyperlink{a00404_a1440c756fe5cb158b78193b2fc1780d1}{AAX\_CParamID}} iParameterID, int32\_t iSelector, int32\_t* oValue)\textcolor{keyword}{ const}}
\DoxyCodeLine{\textcolor{keyword}{}\{}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{a02145}{AAX\_IParameter}} * parameter = mParameterManager.GetParameterByID( iParameterID );}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keywordflow}{if} ( !parameter )}
\DoxyCodeLine{        \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a06161017c1b18c4300e0634502e35b78}{AAX\_ERROR\_INVALID\_PARAMETER\_ID}};}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keywordflow}{if} ( iSelector == \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a99ca84cc3dae0f125082d36893a12bcd}{AAX\_ePageTable\_EQ\_Band\_Type}} )}
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} ( parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_HPF\_Type )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keywordflow}{switch}( parameter-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() )}
\DoxyCodeLine{            \{}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 0 \textcolor{comment}{/*Notch*/}:  *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a5e8aee84ee2cd1db292283e7550e64dc}{AAX\_eEQBandType\_Notch}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 1 \textcolor{comment}{/*HiPass*/}: *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a7827eec27ad12a8abb7f466c629b6482}{AAX\_eEQBandType\_HighPass}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{default}: *oValue = -\/1; \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\_ERROR\_UNIMPLEMENTED}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{            \}}
...
\DoxyCodeLine{        \}}
\DoxyCodeLine{        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} ( parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_LF\_Type )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keywordflow}{switch}( parameter-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() )}
\DoxyCodeLine{            \{}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 0 \textcolor{comment}{/*Peak*/}:  *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a162d60d2812f3786ef5f87d288193e95}{AAX\_eEQBandType\_Parametric}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 1 \textcolor{comment}{/*Shelf*/}: *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a3dbff637a879e2f187f9ad1bbb97c8a3}{AAX\_eEQBandType\_LowShelf}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{default}: *oValue = -\/1; \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\_ERROR\_UNIMPLEMENTED}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{            \}}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\_SUCCESS}};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_HF\_Type )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keywordflow}{switch} (parameter-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() )}
\DoxyCodeLine{            \{}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 0 \textcolor{comment}{/*Peak*/}:  *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a162d60d2812f3786ef5f87d288193e95}{AAX\_eEQBandType\_Parametric}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 1 \textcolor{comment}{/*Shelf*/}: *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95aa36c45b5f1a3dd677fdb14020b83d16f}{AAX\_eEQBandType\_HighShelf}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{default}: *oValue = -\/1; \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\_ERROR\_UNIMPLEMENTED}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{            \}}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\_SUCCESS}};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} ( parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_LPF\_Type )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keywordflow}{switch} ( parameter-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() )}
\DoxyCodeLine{            \{}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 0 \textcolor{comment}{/*Notch*/}:  *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a5e8aee84ee2cd1db292283e7550e64dc}{AAX\_eEQBandType\_Notch}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{case} 1 \textcolor{comment}{/*LoPass*/}: *oValue = \mbox{\hyperlink{a00503_a9ec6da28e827496514bd15d6f2b26d95a5de1272a9829d9d764a7a25adcdae1eb}{AAX\_eEQBandType\_LowPass}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{                \textcolor{keywordflow}{default}: *oValue = -\/1; \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\_ERROR\_UNIMPLEMENTED}}; \textcolor{keywordflow}{break};}
\DoxyCodeLine{            \}}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\_SUCCESS}};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{    \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (iSelector == \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a1a0d975a333d3aee81b22f878697e9c4}{AAX\_ePageTable\_UseAlternateControl}})}
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} ( (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_HPF\_Type ) ||}
\DoxyCodeLine{             (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_HPF\_Q)     ||}
\DoxyCodeLine{             (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_HPF\_Slope)     )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keyword}{const} \mbox{\hyperlink{a02145}{AAX\_IParameter}}* typeParam = mParameterManager.GetParameterByID(EQIII\_HPF\_Type\_Ch);}
\DoxyCodeLine{             *oValue = (typeParam-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() == 0 \textcolor{comment}{/*Notch*/}) ? \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29a5cfea068cc7ea51becccc9d26955e443}{AAX\_eUseAlternateControl\_No}} : \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29aa63097dc0b27e51411f30b06b2db26f1}{AAX\_eUseAlternateControl\_Yes}};}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\_SUCCESS}};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{        \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} ( (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_LPF\_Type) ||}
\DoxyCodeLine{                  (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_LPF\_Q)    ||}
\DoxyCodeLine{                  (parameter-\/>\mbox{\hyperlink{a02145_ae1dae8844a16492726cb6caac7e2e822}{Name}}() == EQIII\_LPF\_Slope)    )}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            \textcolor{keyword}{const} \mbox{\hyperlink{a02145}{AAX\_IParameter}}* typeParam = mParameterManager.GetParameterByID(EQIII\_LPF\_Type\_Ch);}
\DoxyCodeLine{             *oValue = (typeParam-\/>\mbox{\hyperlink{a02145_ad4fc7431439f53cc0253d191b19db00b}{GetStepValue}}() == 0 \textcolor{comment}{/*Notch*/}) ? \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29a5cfea068cc7ea51becccc9d26955e443}{AAX\_eUseAlternateControl\_No}} : \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29aa63097dc0b27e51411f30b06b2db26f1}{AAX\_eUseAlternateControl\_Yes}};}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\_SUCCESS}};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{return} \mbox{\hyperlink{a00506_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\_ERROR\_UNIMPLEMENTED}};}
\DoxyCodeLine{\};  }

\end{DoxyCode}
  Listing 7\+: EQIII Get\+Parameter\+Value\+Info()

As you\textquotesingle{}ll notice, the EQ III plug-\/in has separate controls for Q and Slope in its HPF and LPF bands, depending on whether the band is set to notch or band pass. When the Band Type control is set to notch, the continuous Q control is used. When the Band Type is set to Hi/\+Lo Pass, the discrete Slope control is used. In the page table, the HPF / LPF Q controls are set to the \`{}\`{}Q or Slope\textquotesingle{}\textquotesingle{} in the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} application, and the HPF / LPF Slope controls are set to the \`{}\`{}Q or Slope Alt\textquotesingle{}\textquotesingle{}. Then, with the \mbox{\hyperlink{a01761_a0d3436cb88b4a86fe82a663221a9cfef}{Get\+Parameter\+Value\+Info()}} implementation above, the control surface properly swaps the controls when the band type control is changed. In other words, when the function is called with the \mbox{\hyperlink{a00503_aa169208a2ce713fa021e20deb2eaf608a1a0d975a333d3aee81b22f878697e9c4}{AAX\+\_\+e\+Page\+Table\+\_\+\+Use\+Alternate\+Control}} selector, if the band type control is set to notch, then \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29a5cfea068cc7ea51becccc9d26955e443}{AAX\+\_\+e\+Use\+Alternate\+Control\+\_\+\+No}} is returned in the result and the control surface puts the Q control at that position. If the band type is set to pass, then \mbox{\hyperlink{a00503_abbcc8b4e8207262a5dd9e32047a51a29aa63097dc0b27e51411f30b06b2db26f1}{AAX\+\_\+e\+Use\+Alternate\+Control\+\_\+\+Yes}} is returned and the Slope is placed at that position.  Collaboration diagram for Page Table Guide\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=305pt]{a00849}
\end{center}
\end{figure}
