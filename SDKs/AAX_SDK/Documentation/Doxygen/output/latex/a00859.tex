\hypertarget{a00859}{}\doxysection{Distributing Your AAX Plug-\/\+In}
\label{a00859}\index{Distributing Your AAX Plug-\/In@{Distributing Your AAX Plug-\/In}}
Details about packaging and distributing your AAX plug-\/ins. 

\hypertarget{a00859_aax_distributing_contents}{}\doxysubsection{Contents}\label{a00859_aax_distributing_contents}

\begin{DoxyItemize}
\item \mbox{\hyperlink{a00859_aax_distributing_finishing}{The finishing touches}}
\item \mbox{\hyperlink{a00859_aax_distributing_installer}{Building your plug-\/in installer}}
\item \mbox{\hyperlink{a00859_aax_distributing_testing}{Testing your plug-\/in}}
\item \mbox{\hyperlink{a00859_aax_distributing_selling}{Selling your plug-\/in}}
\end{DoxyItemize}

 \hypertarget{a00859_aax_distributing_finishing}{}\doxysubsection{The finishing touches}\label{a00859_aax_distributing_finishing}
 You\textquotesingle{}ve completed your main development work and your new AAX plug-\/in is nearly ready to ship! Now it\textquotesingle{}s time to put the polish on your release.

\hypertarget{a00859_aax_distributing_finishing_pagetables}{}\doxysubsubsection{Check and finalize page tables}\label{a00859_aax_distributing_finishing_pagetables}
 After development has completed on your plug-\/in, we recommend that you check and finalize the plug-\/in\textquotesingle{}s page tables using the \mbox{\hyperlink{a00849_subsection_creating_page_tables_in_pete}{Page Table Editor}} tool. It can be easy to forget to update the plug-\/in\textquotesingle{}s page tables after making changes to the plug-\/in\textquotesingle{}s list of parameters or to other aspects of the plug-\/in during development. To check for problems, open and view the plug-\/in\textquotesingle{}s page tables for every layout in the editor app. Verify that the plug-\/in parameters are arranged properly for each control surface and that the list of available parameters in each layout is correct.
...
\hypertarget{a00859_aax_distributing_finishing_factorypresets}{}\doxysubsubsection{Create factory presets}\label{a00859_aax_distributing_finishing_factorypresets}
 Each AAX plug-\/in may be bundled with a set of factory presets. These presets will be made available to users through the host application\textquotesingle{}s plug-\/in preset management UI.
...
\end{DoxyEnumerate}
 ...
 Once you have saved your desired factory presets as .tfx files onto your system you can package them with your plug-\/in bundle in $\ast$.aaxplugin/\+Contents/\+Factory Presets. Any presets found in this directory will be copied to the plug-\/in settings location for the running instance of Pro Tools when Pro Tools scans the plug-\/in on launch. See \mbox{\hyperlink{a00816_commoninterface_formatspecification__aaxplugin_directory_structure}{.aaxplugin Directory Structure}} for more information about supported sub-\/directories within the .aaxplugin bundle.

 The feature for automatically copying factory presets from the .aaxplugin bundle to the plug-\/in settings directory on the user\textquotesingle{}s system is supported by Pro Tools 11 and later and by all versions of Media Composer with AAX plug-\/in support.
...
\item Win\+: C\+:\textbackslash{}Program Files(x86)\textbackslash{}Common Files\textbackslash{}Digidesign\textbackslash{}DAE\textbackslash{}Plug-\/\+In Settings  
\end{DoxyItemize}
 ...
 Default plug-\/in settings locations for 64-\/bit \mbox{\hyperlink{a00868}{AAX}} plug-\/in hosts\+:
...
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00846_subsection__presets_and_settings_management}{Pro Tools}}  
\item \mbox{\hyperlink{a00847_subsection__aax_media_composer_guide__features__presets}{Media Composer}}  
\item \mbox{\hyperlink{a00865_subsection__aax_venue_guide__features__presets}{VENUE}}  
\end{DoxyItemize}

\hypertarget{a00859_aax_distributing_finishing_signature}{}\doxysubsubsection{Sign your plug-\/in}\label{a00859_aax_distributing_finishing_signature}
 Pro Tools requires that all AAX plug-\/ins be signed with a digital signature. The certificate authority for this signature is PACE Anti-\/\+Piracy, Inc. and all AAX plug-\/ins for Pro Tools must be signed with the digital signing tools from PACE. See the \mbox{\hyperlink{a00846_subsection__digital_signature_}{Digital signature}} section in the \mbox{\hyperlink{a00846}{Pro Tools Guide}} for more information about this requirement.



 \hypertarget{a00859_aax_distributing_installer}{}\doxysubsection{Building your plug-\/in installer}\label{a00859_aax_distributing_installer}
 Your plug-\/in installer should place all .aaxplugin bundles into the system\textquotesingle{}s AAX Plug-\/\+Ins directory\+:
...
\hypertarget{a00859_aax_distributing_installer_trackpresets}{}\doxysubsubsection{Installing Track Presets}\label{a00859_aax_distributing_installer_trackpresets}
...
\begin{DoxyItemize}
\item {\itshape Auto\+Pan; BF-\/76; Channel Strip; Click II; Dither; Down Mixer; D-\/\+Verb; Dynamics III; Eleven Lite; EQ III; In\+Tune; Invert/\+Duplicate; Lo\+Fi; Master Meter; Maxim; Mod\+Delay III; Normalize-\/\+Gain; Pitch Shift Legacy; Pitch II; Recti\+Fi; Reverse/\+DC Removal; Sans\+Amp PSA-\/1; Sci\+Fi; Signal Generator; Time Shift; Time Adjuster; Trim; Vari\+Fi}  
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape Boom; DB-\/33; Mini Grand; Structure Free; Vacuum; Xpand!2}  
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
 ...
 \hypertarget{a00859_aax_distributing_testing}{}\doxysubsection{Testing your plug-\/in}\label{a00859_aax_distributing_testing}
 The AAX Plug-\/\+In Burnthrough Grid document describes a number of test cases and workflows for multiple AAX plug-\/in hosts. This document is available for download as part of the AAX SDK Toolkit on the \href{https://my.avid.com/products/cppsdk}{\texttt{ My Toolkits and Downloads}} page at avid.\+com.



 \hypertarget{a00859_aax_distributing_selling}{}\doxysubsection{Selling your plug-\/in}\label{a00859_aax_distributing_selling}
 \hypertarget{a00859_aax_distributing_selling_avidmarketplace}{}\doxysubsubsection{Avid Marketplace}\label{a00859_aax_distributing_selling_avidmarketplace}
 Avid may offer to sell your compatible products through our online store. We offer test tools and support services that will help you get your products to market with the highest quality whether you decide to offer them through our online store or independently. Registered developers can further register as Sellers, then work with Avid to add their solutions to the online store. Please visit your My Avid account and go to \char`\"{}\+My Developer Account\char`\"{} then to \char`\"{}\+Access Seller Portal\char`\"{} to explore this program or write to \href{mailto:partners@avid.com}{\texttt{ partners@avid.\+com}} for more information.

 Get your AAX Plug-\/\+In ready for sale on Avid Marketplace by following these steps\+: 
\begin{DoxyItemize}
\item {\itshape Explore the Avid Webstore} -\/ Review the \href{http://www.avid.com/alliance-partner-program/about-marketplace}{\texttt{ Avid Webstore description}} and learn about this valuable and expanding offering. E-\/mail us at \href{mailto:partners@avid.com}{\texttt{ partners@avid.\+com}} with your questions.  
...
\item {\itshape Prepare your submission} -\/ Gather the plug-\/in and other information required to onboard as described in the Onboarding FAQ. Your experience will be easier if you collect these items in advance.  
...
\hypertarget{a00859_aax_distributing_selling_inapppurchase}{}\doxysubsubsection{In-\/\+App Purchase}\label{a00859_aax_distributing_selling_inapppurchase}
 ...
 See \href{https://dev.avid.com/MP_DeveloperForumAnnouncement?AnnouncementId=aBe3100000002bMCAQ}{\texttt{ this article}} for more information about how to add support for In-\/\+App Purchase to your on-\/boarded AAX plug-\/ins. Additional documentation regarding In-\/\+App Purchase is available under the \char`\"{}\+In-\/\+App Purchase Tools\char`\"{} section of the \href{https://my.avid.com/products/cppsdk}{\texttt{ AAX SDK Toolkit}} downloads page in your avid.\+com account.
