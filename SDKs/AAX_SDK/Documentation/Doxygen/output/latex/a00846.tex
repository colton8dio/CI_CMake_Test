\hypertarget{a00846}{}\doxysection{Pro Tools Guide}
\label{a00846}\index{Pro Tools Guide@{Pro Tools Guide}}
Details about using AAX plug-\/ins in Pro Tools. 

\hypertarget{a00846_aax_pro_tools_guide_contents}{}\doxysubsection{Contents}\label{a00846_aax_pro_tools_guide_contents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00846_aax_pro_tools_guide_00_about_this_document}{About this document}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_01_processing_modes}{Processing modes}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_02_requirements_for_aax_plugin_compatibility_with_pro_tools}{Requirements for AAX plug-\/in compatibility with Pro Tools}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_03_audio_engine_behavior}{Audio Engine Behavior and Features}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_04_basic_plugin_operation}{Basic plug-\/in operation}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_05_optional_plugin_features}{Optional plug-\/in features}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_06_debugging_aax_plugins}{Debugging AAX plug-\/ins}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_06b_troubleshooting_aax_plugin_failures}{Troubleshooting common AAX plug-\/in failures}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_06c_digioptions}{Using Digi\+Options}} \item \mbox{\hyperlink{a00846_aax_pro_tools_guide_07_compatibility_notes}{Compatibility Notes}}\end{DoxyItemize}
 \hypertarget{a00846_aax_pro_tools_guide_00_about_this_document}{}\doxysubsection{About this document}\label{a00846_aax_pro_tools_guide_00_about_this_document}
...
{\itshape This guide is a work in progress, and is extended as needed to describe different aspects of and caveats to the Pro Tools implementation of the AAX host spec.} 
 ...
 \hypertarget{a00846_aax_pro_tools_guide_01_processing_modes}{}\doxysubsection{Processing modes}\label{a00846_aax_pro_tools_guide_01_processing_modes}
...
\hypertarget{a00846_subsection__realtime_processing}{}\doxysubsubsection{Real-\/time processing}\label{a00846_subsection__realtime_processing}
...
\hypertarget{a00846_subsubsection__native_realtime_processing_}{}\doxyparagraph{Native real-\/time processing}\label{a00846_subsubsection__native_realtime_processing_}
...
\hypertarget{a00846_subsubsection__dsp_realtime_processing_}{}\doxyparagraph{DSP real-\/time processing}\label{a00846_subsubsection__dsp_realtime_processing_}
...
\hypertarget{a00846_subsubsection__cpu_reporting_}{}\doxyparagraph{CPU reporting}\label{a00846_subsubsection__cpu_reporting_}
...
\hypertarget{a00846_subsection__non-real-time_processing_audiosuite}{}\doxysubsubsection{Non-\/real-\/time processing (\+Audio\+Suite)}\label{a00846_subsection__non-real-time_processing_audiosuite}
...
\hypertarget{a00846_subsection__multichannel_and_multimono}{}\doxysubsubsection{Multichannel and Multi-\/\+Mono}\label{a00846_subsection__multichannel_and_multimono}
...
For more information about multi-\/mono mode, please refer to the Pro Tools Reference Guide.
 ...
 \hypertarget{a00846_aax_pro_tools_guide_02_requirements_for_aax_plugin_compatibility_with_pro_tools}{}\doxysubsection{Requirements for AAX plug-\/in compatibility with Pro Tools}\label{a00846_aax_pro_tools_guide_02_requirements_for_aax_plugin_compatibility_with_pro_tools}
...
\hypertarget{a00846_subsection__install_directories_}{}\doxysubsubsection{Install directories}\label{a00846_subsection__install_directories_}
 AAX plug-\/ins must be installed in the system\textquotesingle{}s AAX Plug-\/\+Ins directory. See \mbox{\hyperlink{a00859_aax_distributing_installer}{Building your plug-\/in installer}} for more information about creating a plug-\/in installer.
...
\hypertarget{a00846_subsection__file_name_}{}\doxysubsubsection{Plug-\/in name and file structure}\label{a00846_subsection__file_name_}
 In order to be recognized by AAE, all AAX plug-\/in bundles must use the \char`\"{}.\+aaxplugin\char`\"{} file name suffix. On OS X, the plug-\/in bundle must use this suffix while the binary itself does not require a suffix. On Windows, the plug-\/in binary (DLL) must use this suffix.

The directory structure of an AAX plug-\/in bundle is also important. See \mbox{\hyperlink{a00816_commoninterface_formatspecification__aaxplugin_directory_structure}{.aaxplugin Directory Structure}} in the \mbox{\hyperlink{a00816}{AAX Format Specification}} document for more information.

\hypertarget{a00846_subsection__digital_signature_}{}\doxysubsubsection{Digital signature}\label{a00846_subsection__digital_signature_}
...
\end{DoxyNote}
If you are having problems with digitally signing your plug-\/ins see the \mbox{\hyperlink{a00858_troubleshooting_loading}{Plug-\/\+In Fails to Load in Shipping Pro Tools}} section in the \mbox{\hyperlink{a00858}{Troubleshooting}} guide.

 Requesting the digital signing toolkit

The AAX digital signatures required by Pro Tools are generated using digital signing tools licensed from PACE Anti-\/\+Piracy, Inc., which acts as the certificate authority for all AAX digital signatures. To request access to these tools, send an e-\/mail to \href{mailto:partners@avid.com?subject=Pace Tools Request}{\texttt{ partners@avid.\+com}} with \char`\"{}\+Pace Tools Request\char`\"{} in the subject. Include the following information in your request\+:


\begin{DoxyItemize}
\item Company name
\item Company mailing address
\item Contact information for your AAX development lead or team
...
\item[\mbox{\hyperlink{a00801__compatibility_notes000010}{Host Compatibility Notes}}]Pro Tools 11 requires PACE Eden digital signatures for AAX plug-\/ins.\end{DoxyRefDesc}
...
Pro Tools 11 and higher will only accept the Eden signature; AAX plug-\/ins signed by earlier generations of PACE digital signing tools will not load in Pro Tools 11.
 ...
 \begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000011}{Host Compatibility Notes}}]Pro Tools 10 requires either PACE DSig or Eden digital signatures for AAX plug-\/ins.\end{DoxyRefDesc}


For compatibility with Pro Tools 10, AAX plug-\/ins must be digitally signed using PACEDSig\+Tool.
...
Pro Tools 10.\+3.\+5 and above also support the new Eden signatures from PACE, so that universal binaries can be shipped which target both Pro Tools 11 or later and Pro Tools 10.\+3.\+5 or later.
 ...
 \begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000012}{Host Compatibility Notes}}]As of Pro Tools 10.\+2, support has been added to allow binary-\/level encryption of AAX DSP algorithms. Please note that this is {\itshape NOT} a requirement of AAX DSP plug-\/ins, and serves only as an additional security measure to protect an algorithm\textquotesingle{}s DLL.\end{DoxyRefDesc}
...
\end{DoxyItemize}
 ...
 \hypertarget{a00846_aax_pro_tools_guide_03_audio_engine_behavior}{}\doxysubsection{Audio Engine Behavior and Features}\label{a00846_aax_pro_tools_guide_03_audio_engine_behavior}
 Pro Tools hosts AAX plug-\/ins using the {\itshape  Avid Audio Engine} (AAE). AAE implements all host-\/side AAX interfaces such as \mbox{\hyperlink{a02077}{AAX\+\_\+\+IController}} and the \mbox{\hyperlink{a02065}{AAX\+\_\+\+ICollection}}.

\hypertarget{a00846_subsection__plugin_loading_and_aae_initialization}{}\doxysubsubsection{Plug-\/in loading and AAE initialization}\label{a00846_subsection__plugin_loading_and_aae_initialization}
...
\begin{DoxyNote}{Note}
We recommend that you always enable the {\ttfamily Always\+Rebuild\+Cache} Digi\+Option during plug-\/in development. See \mbox{\hyperlink{a00846_aax_pro_tools_guide_06c_digioptions}{Using Digi\+Options}} for more information.
\end{DoxyNote}
\hypertarget{a00846_subsection__plugin_initialization}{}\doxysubsubsection{Plug-\/in initialization}\label{a00846_subsection__plugin_initialization}
...
\item The default state of the plug-\/in is set (see \mbox{\hyperlink{a00846_subsubsection__default_plugin_settings_}{Default plug-\/in settings}})  
...
\hypertarget{a00846_subsection__runtime_processing_behavior}{}\doxysubsubsection{Run-\/time processing behavior}\label{a00846_subsection__runtime_processing_behavior}
...
\begin{DoxyItemize}
\item {\itshape (HDX and Native)} If there is any live audio or MIDI feeding into the plug-\/in\textquotesingle{}s track and if the track is sending audio to an active output then all plug-\/in instances on the track will be run at low latency. 
\item {\itshape (HDX only)} If any AAX DSP plug-\/in instances are present in the signal path that feeds an AAX Native plug-\/in instance then the AAX Native plug-\/in will be run at low latency. 
\item {\itshape (HDX only)} Any AAX Native plug-\/in instance on an AUX track will be run at low latency. 
\end{DoxyItemize}
...
\hypertarget{a00846_subsection__new_to_pro_tools_11}{}\doxysubsubsection{New to Pro Tools 11}\label{a00846_subsection__new_to_pro_tools_11}
...
For a full list of compatibility and feature differences between different AAX plug-\/in hosts, see \mbox{\hyperlink{a00861}{Host Support}}.

\hypertarget{a00846_subsubsection__deterministic_plug-in_automation}{}\doxyparagraph{Deterministic Plug-\/in Automation}\label{a00846_subsubsection__deterministic_plug-in_automation}
...
\hypertarget{a00846_subsubsection__deprecated_and_related_plug-in_lists}{}\doxyparagraph{Deprecated and Related Plug-\/in Lists}\label{a00846_subsubsection__deprecated_and_related_plug-in_lists}
...
\hypertarget{a00846_subsubsection__offline_bounce}{}\doxyparagraph{Offline Bounce}\label{a00846_subsubsection__offline_bounce}
...
\hypertarget{a00846_subsubsection__aax-hybrid_plug-ins}{}\doxyparagraph{AAX Hybrid Plug-\/ins}\label{a00846_subsubsection__aax-hybrid_plug-ins}
 Pro Tools 11 also supports \mbox{\hyperlink{a00820}{AAX Hybrid}} plug-\/ins, which can have both a Native and a DSP algorithm processing component. Audio-\/rate data can also be shared between the two processing components, which allows you to split your algorithm up into low-\/latency and high-\/latency contexts for better efficiency and to enable plug-\/ins such as convolution reverbs, spectrum analyzers, and other similar architectures.



 \hypertarget{a00846_aax_pro_tools_guide_04_basic_plugin_operation}{}\doxysubsection{Basic plug-\/in operation}\label{a00846_aax_pro_tools_guide_04_basic_plugin_operation}
\hypertarget{a00846_subsection__configuration_management}{}\doxysubsubsection{Configuration management}\label{a00846_subsection__configuration_management}
...
\hypertarget{a00846_subsection__plugin_activation_and_deactivation}{}\doxysubsubsection{Plug-\/in activation and deactivation}\label{a00846_subsection__plugin_activation_and_deactivation}
...
\hypertarget{a00846_subsection__plugin_bypass}{}\doxysubsubsection{Plug-\/in bypass}\label{a00846_subsection__plugin_bypass}
...
Any algorithmic delay that a plug-\/in incurs during normal operation must be maintained by the plug-\/in during bypass. For more information about this requirement, see \mbox{\hyperlink{a00846_subsubsection__automatic_delay_compensation_}{Automatic Delay Compensation}}.

\hypertarget{a00846_subsection__presets_and_settings_management}{}\doxysubsubsection{Presets and settings management}\label{a00846_subsection__presets_and_settings_management}
...
Preset files can be bundled with an AAX plug-\/in to demonstrate a variety of uses for the plug-\/in or as recommended settings for different situations, and, as a plug-\/in developer, you are encouraged to provide a large selection of pre-\/configured presets along with your AAX plug-\/ins. See \mbox{\hyperlink{a00859_aax_distributing_finishing_factorypresets}{Create factory presets}} for more information about bundling presets with your plug-\/in.
...
\hypertarget{a00846_subsubsection__plugin_preset_menu_}{}\doxyparagraph{The plug-\/in preset menu}\label{a00846_subsubsection__plugin_preset_menu_}
...
\hypertarget{a00846_subsubsection__plugin_presets_}{}\doxyparagraph{Factory presets}\label{a00846_subsubsection__plugin_presets_}
...
Where {\itshape My\+Plug\+In\+Package} is the plug-\/in\textquotesingle{}s longest \mbox{\hyperlink{a02065_acf7410e0d06cf64bea36bf7d18b3456c}{Package Name}} with 16 characters or fewer.

On Pro Tools launch, all installed AAX plug-\/in settings are copied from the .aaxplugin bundles\textquotesingle{} \char`\"{}\+Factory Presets\char`\"{} folders into the User Library directory (see \mbox{\hyperlink{a00846_subsubsection__plugin_preset_menu_}{above}}.)
...
\end{DoxyNote}
\hypertarget{a00846_subsubsection__default_plugin_settings_}{}\doxyparagraph{Default plug-\/in settings}\label{a00846_subsubsection__default_plugin_settings_}
...
\begin{DoxyEnumerate}
\item Instantiate the plug-\/in and create a \mbox{\hyperlink{a02113}{AAX\+\_\+\+IEffect\+Parameters}} object  
...
\item Send the instance a \mbox{\hyperlink{a00503_afab5ea2cfd731fc8f163b6caa685406ea013a21c2c111bac54b962b40f1b4bc1f}{AAX\+\_\+e\+Notification\+Event\+\_\+\+Session\+Being\+Opened}} notification  
\item Set the saved settings from the session  
\end{DoxyEnumerate}

\hypertarget{a00846_subsubsection__the_compare_light_}{}\doxyparagraph{The Compare Light}\label{a00846_subsubsection__the_compare_light_}
...
The specific operation of the Compare Light is determined by the plug-\/in\textquotesingle{}s implementation of \mbox{\hyperlink{a02113}{AAX\+\_\+\+IEffect\+Parameters}}. To determine the correct state for a plug-\/in\textquotesingle{}s compare light, Pro Tools makes regular calls to \mbox{\hyperlink{a01953_a17b96da201d9a242d3662e87525a7227}{AAX\+\_\+\+IEffect\+Parameters\+::\+Get\+Number\+Of\+Changes()}} from a callback timer. If this method\textquotesingle{}s {\ttfamily a\+ValueP} parameter has changed since the last time the plug-\/in was queried then Pro Tools proceeds to call \mbox{\hyperlink{a01953_a1e86f849e970c9998313fc7d451ccf85}{Compare\+Active\+Chunk()}}. If \mbox{\hyperlink{a01953_a1e86f849e970c9998313fc7d451ccf85}{Compare\+Active\+Chunk()}} returns with {\ttfamily is\+Equal==false} then the Compare Light will be lit, otherwise the light will be dimmed.

\hypertarget{a00846_subsubsection__basic_chunk_handling_}{}\doxyparagraph{Basic chunk handling}\label{a00846_subsubsection__basic_chunk_handling_}
 All of these situations use the same basic settings management infrastructure in Pro Tools, which uses the \char`\"{}chunk\char`\"{} API of \mbox{\hyperlink{a02113}{AAX\+\_\+\+IEffect\+Parameters}} to retrieve arbitrary blocks of data from the plug-\/in (to retrieve a preset) and send the same block back to the plug-\/in (to set a preset.)
...
\hypertarget{a00846_subsection__modifier_key_behavior_}{}\doxysubsubsection{Modifier key behavior}\label{a00846_subsection__modifier_key_behavior_}
...
Shift-\/click &Shift-\/click &\mbox{\hyperlink{a00840}{Link parameters}} across all channels, if applicable  \\\cline{1-3}
\multicolumn{3}{|l|}{
...
In order to allow the AAX host to handle these operations, a plug-\/in must always call the handler methods in \mbox{\hyperlink{a02177}{AAX\+\_\+\+IView\+Container}} before handling any mouse events in its own GUI. It is important to call these methods for {\itshape all} mouse events, in case additional handlers are added to future versions of the host or the plug-\/in is run in a new AAX host with a different set of handled modifier key combinations.

See the \mbox{\hyperlink{a02177}{AAX\+\_\+\+IView\+Container}} class documentation for more information about passing mouse events to the AAX host.



 \hypertarget{a00846_aax_pro_tools_guide_05_optional_plugin_features}{}\doxysubsection{Optional plug-\/in features}\label{a00846_aax_pro_tools_guide_05_optional_plugin_features}
...
\hypertarget{a00846_subsection__audio_management_features}{}\doxysubsubsection{Audio management features}\label{a00846_subsection__audio_management_features}
\hypertarget{a00846_subsubsection__sidechain_input_}{}\doxyparagraph{Sidechain input}\label{a00846_subsubsection__sidechain_input_}
If applicable, plug-\/ins may choose to enable \mbox{\hyperlink{a00823}{sidechain inputs}}. If a sidechain is enabled, a menu is added to the plug-\/in\textquotesingle{}s header that allows the user to choose an interface or bus as the sidechain, or \char`\"{}key input\char`\"{}. For Audio\+Suite, the user can only use an existing audio track as the sidechain input. Once enabled, the plug-\/in will be able to access sidechain input just like any other input signal.

\hypertarget{a00846_subsubsection__auxiliary_output_stems_}{}\doxyparagraph{Auxiliary Output Stems}\label{a00846_subsubsection__auxiliary_output_stems_}
Pro Tools has the capability to show and route multiple \char`\"{}auxiliary\char`\"{} outputs from a plug-\/in to other tracks. These are known as \mbox{\hyperlink{a00824}{Auxiliary Output Stems}} (AOS), a stem referring to one set of outputs. A stereo stem contains two outputs, left and right, and a mono stem contains one output. The outputs will appear in the input assignment pop-\/up menu of each track under the category \char`\"{}plug-\/in\char`\"{}.
...
\hypertarget{a00846_subsubsection__external_metering_and_internal_clip_}{}\doxyparagraph{External metering and internal clip}\label{a00846_subsubsection__external_metering_and_internal_clip_}
 Pro Tools may use the meter values reported by a plug-\/in for display on attached control surfaces and other external plug-\/in views. In general, the behavior of a plug-\/in meter on these devices will depend on the meter\textquotesingle{}s properties as registered in Describe. The meter behavior may also depend on the plug-\/in\textquotesingle{}s registered category. See \mbox{\hyperlink{a00822}{Plug-\/in meters}} for more information about how to register your plug-\/in\textquotesingle{}s meters.
...
All registered plug-\/in gain reduction meters are used by the Pro Tools gain-\/reduction metering UI. The plug-\/in gain reduction meters in the Pro Tools Mix and Edit windows will combine metering data for all gain-\/reduction meters of the same type (\mbox{\hyperlink{a00503_a590815545eaf0d3be0bb8f656fe2a761af93404c1998a39f398adbb788355248f}{Compressor/\+Limiter}} or \mbox{\hyperlink{a00503_a590815545eaf0d3be0bb8f656fe2a761a58188550947e94f506dc0e43fe7cf302}{Expander/\+Gate}}) in the plug-\/in\+:
...
Pro Tools can be set up to display \mbox{\hyperlink{a00503_a590815545eaf0d3be0bb8f656fe2a761af93404c1998a39f398adbb788355248f}{Compressor/\+Limiter}}, \mbox{\hyperlink{a00503_a590815545eaf0d3be0bb8f656fe2a761a58188550947e94f506dc0e43fe7cf302}{Expander/\+Gate}}, or both types of metering data in these displays via Preferences $>$ Metering $>$ Display $>$ Gain Reduction Meter Type. If both types are used, the displayed meter level is simply the sum of the selected values for each type.
...
\hypertarget{a00846_subsubsection__automatic_delay_compensation_}{}\doxyparagraph{Automatic Delay Compensation}\label{a00846_subsubsection__automatic_delay_compensation_}
...
\hypertarget{a00846_subsection__plugin_categories}{}\doxysubsubsection{Plug-\/in categories}\label{a00846_subsection__plugin_categories}
 The plug-\/in menus in Pro Tools are hierarchical and by default are organized by category. These general categories represent common plug-\/in functions like EQ, dynamics, reverb, etc. Plug-\/ins may report one or more of these categories in order to be placed into the proper menu. For a complete list of plug-\/in categories available, refer to the \mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4a}{AAX\+\_\+\+EPlug\+In\+Category}} enum.
...
\hypertarget{a00846_subsection__advanced_non-real-time_processing}{}\doxysubsubsection{Advanced non-\/real-\/time processing}\label{a00846_subsection__advanced_non-real-time_processing}
 Audio\+Suite processing allows AAX plug-\/in to operate on audio in a non-\/real-\/time manner. Audio\+Suite plug-\/ins will appear in the Audio\+Suite menu in Pro Tools. By default, any AAX-\/\+Native plug-\/in will appear in the menu as long as an \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0dad3344696b8298a8b254add3d039ea927}{AAX\+\_\+e\+Property\+\_\+\+Plug\+In\+ID\+\_\+\+Audio\+Suite}} property is defined alongside the corresponding \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da89ca3dd6e96895cda14976c1b1ceb826}{AAX\+\_\+e\+Property\+\_\+\+Plug\+In\+ID\+\_\+\+Native}} ID. However, to make use of extended Audio\+Suite features such as non-\/real-\/time sample access, the Analysis pass, a separate entry method subclassed from the \mbox{\hyperlink{a01765}{AAX\+\_\+\+CHost\+Processor}} implementation in the SDK should be used.

\hypertarget{a00846_subsubsection__audiosuite_processing_modes_}{}\doxyparagraph{Audio\+Suite processing modes}\label{a00846_subsubsection__audiosuite_processing_modes_}
...
The plug-\/in may optionally disable the \char`\"{}clip by clip\char`\"{} processing mode if continuous input data is required, by using the property \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da95054276be8782d93437cd74669366d0}{AAX\+\_\+e\+Property\+\_\+\+Continuous\+Only}}.
...
The plug-\/in may optionally disable \char`\"{}mono mode\char`\"{} processing if its algorithm is only valid for multi-\/channel input, by defining the \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0daa15cf3edd899af4a98fa18fcdfdeb9d6}{AAX\+\_\+e\+Property\+\_\+\+Multi\+Input\+Mode\+Only}} property.

\hypertarget{a00846_subsubsection__analysis_}{}\doxyparagraph{Analysis}\label{a00846_subsubsection__analysis_}
 Audio\+Suite plug-\/ins support and optional Analysis pass, which allows a plug-\/in to access the incoming audio before the actual Render pass starts. When Analysis is defined with either \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da5a2bacb421fc36f890a121f01a9e72ba}{AAX\+\_\+e\+Property\+\_\+\+Optional\+Analysis}} or \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da925c49bb79454b33bf1d5f4cb09d373f}{AAX\+\_\+e\+Property\+\_\+\+Requires\+Analysis}}, an Analyze button will appear in the plug-\/in footer in the GUI.
...
\hypertarget{a00846_subsubsection__reverse_}{}\doxyparagraph{Reverse}\label{a00846_subsubsection__reverse_}
 A \char`\"{}reverse\char`\"{} feature is available for \mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4aa3a6bc05ef91a38b7c496236b8a28ab6d}{Reverb}} and \mbox{\hyperlink{a00503_aef9637518fb1ac0e2f403444c73aba4aa30cbbd310bb38aad2326dc183f9ca27b}{Delay}} Audio\+Suite plug-\/ins. This effect will reverse the source audio, apply the Audio\+Suite plug-\/in processing, and re-\/reverse the source audio back to its original orientation, thereby applying the Audio\+Suite effect in reverse.
...
\hypertarget{a00846_subsubsection__random-access_and_non-linear_processing_}{}\doxyparagraph{Random-\/access and non-\/linear processing}\label{a00846_subsubsection__random-access_and_non-linear_processing_}
...
\hypertarget{a00846_subsubsection__audiosuite_handles_}{}\doxyparagraph{Audio\+Suite Handles}\label{a00846_subsubsection__audiosuite_handles_}
...
The reason for this feature is so that the user has some room to expand the resulting audio clip (for fades or other reasons). However, certain Audio\+Suite plug-\/ins will operate more intuitively if these handles are not processed (such as delay, reverb, loudness normalization, and other plug-\/in types). To disable extended handle processing, set the \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0da943c37cd8a41a4d271dd28c89b518044}{AAX\+\_\+e\+Property\+\_\+\+Disable\+Handles}} property to true.



\hypertarget{a00846_subsubsection_extended_features}{}\doxyparagraph{Extended features}\label{a00846_subsubsection_extended_features}
 AAX-\/\+Audio\+Suite plug-\/ins also have several other optional features including custom progress dialogs, reverse mode, and side-\/chains. For a complete reference of supported Audio\+Suite-\/related properties, refer to the properties between \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0dae774ad8d49f9d021fc39e7d9c6f08070}{AAX\+\_\+e\+Property\+\_\+\+Audiosuite\+Props\+Base}} and \mbox{\hyperlink{a00674_a13e384f22825afd3db6d68395b79ce0dac1731b45ed9daa8380c224c9d2b4050a}{AAX\+\_\+e\+Property\+\_\+\+Max\+ASProp}} found in Interfaces\textbackslash{}\+AAX\+\_\+\+Properties.\+h.



 \hypertarget{a00846_aax_pro_tools_guide_06_debugging_aax_plugins}{}\doxysubsection{Debugging AAX plug-\/ins}\label{a00846_aax_pro_tools_guide_06_debugging_aax_plugins}
 \hypertarget{a00846_subsection__debugging_within_pro_tools}{}\doxysubsubsection{Debugging within Pro Tools}\label{a00846_subsection__debugging_within_pro_tools}
...
As an AAX plug-\/in developer, you are granted access to debuggable \char`\"{}developer build\char`\"{} versions of Pro Tools to help your development efforts. Some Pro Tools developer builds are feature-\/limited; for example, developer builds of Pro Tools 10 do not allow saving or exporting sessions.
...
Both debuggable and pre-\/release versions are available for download as part of the AAX SDK Toolkit on the \href{https://my.avid.com/products/cppsdk}{\texttt{ My Toolkits and Downloads}} page at avid.\+com.

\hypertarget{a00846_subsection__digishell}{}\doxysubsubsection{Digi\+Shell}\label{a00846_subsection__digishell}
...
More information about DSH in general and about loading and testing plug-\/ins in DSH can be found in \mbox{\hyperlink{a00851}{DSH Guide}}.

\hypertarget{a00846_subsection__digitrace}{}\doxysubsubsection{Digi\+Trace}\label{a00846_subsection__digitrace}
...
To enable trace logging for AAX plug-\/ins, use the {\ttfamily AAX\+\_\+\+TRACE} macro defined in {\ttfamily \mbox{\hyperlink{a00407}{AAX\+\_\+\+Assert.\+h}}}. A separate macro, {\ttfamily AAX\+\_\+\+ASSERT}, is also available to signal run-\/time errors. These macros are both cross-\/platform and will function whether the algorithm is running on the TI or on the host.

For more information about Digi\+Trace, see \mbox{\hyperlink{a00850}{Digi\+Trace Guide}}.

\hypertarget{a00846_subsubsection__tracing_requirements}{}\doxyparagraph{Tracing requirements}\label{a00846_subsubsection__tracing_requirements}
 The \mbox{\hyperlink{a00407_a168ee44fd7a5485ab50160db36fb2988}{AAX\+\_\+\+ASSERT}} and \mbox{\hyperlink{a00407_ab53f1d6a94f8b6ebb3a101f71bfe4e82}{AAX\+\_\+\+TRACE}} macros are debug-\/only and will not provide tracing output from release builds of your plug-\/in. \mbox{\hyperlink{a00407_ac2aa820ece56bb59140ad561218db4b3}{AAX\+\_\+\+TRACE\+\_\+\+RELEASE}} may be used for tracing in both debug and release configurations. These macros require that the {\ttfamily DTF\+\_\+\+AAXPLUGINS} facility to your Digi\+Trace configuration file. You can toggle this facility to enable or disable AAX algorithm-\/level tracing. For details on setting up tracing on AAX TI plug-\/ins, please refer to the \mbox{\hyperlink{a00848}{TI DSP Guide}}.



 \hypertarget{a00846_aax_pro_tools_guide_06b_troubleshooting_aax_plugin_failures}{}\doxysubsection{Troubleshooting common AAX plug-\/in failures}\label{a00846_aax_pro_tools_guide_06b_troubleshooting_aax_plugin_failures}
...
The {\ttfamily DTF\+\_\+\+AAXHOST} \mbox{\hyperlink{a00850}{Digi\+Trace}} facility provides additional information about AAX plug-\/in load errors.
...
\end{DoxyItemize}
 ...
 \hypertarget{a00846_aax_pro_tools_guide_06c_digioptions}{}\doxysubsection{Using Digi\+Options}\label{a00846_aax_pro_tools_guide_06c_digioptions}
...
\end{DoxyNote}
\hypertarget{a00846_subsection__useful_digioptions}{}\doxysubsubsection{Useful Digi\+Options}\label{a00846_subsection__useful_digioptions}
 \begin{DoxyNote}{Note}
...
\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000014}{Host Compatibility Notes}}]Supported in Pro Tools 12 and higher.\end{DoxyRefDesc}
...
\begin{DoxyEnumerate}
\item Off 
\item \mbox{\hyperlink{a00827_gga59c73d8f51c5c55d54a728eff39da884a01b32d7031ceff45f7acad05dcddad19}{EQ curve}} 
\item \mbox{\hyperlink{a00827_gga59c73d8f51c5c55d54a728eff39da884a011b1b00d6189a8903735dcae2f8bc93}{Gain reduction curve}} 
\end{DoxyEnumerate}\begin{DoxyWarning}{Warning}
The implementations of this test curve and the actual curve data shown on Avid control surfaces are different. In particular, the display in Pro Tools is updated regularly at idle time, whereas the curve on a control surface is only updated when certain parameter changes occur (see \mbox{\hyperlink{a00862_PTSW-195316}{PTSW-\/195316 / PT-\/218485}}). The graph point interpolation, range, and sample points are also not exactly equivalent to the values used on an actual control surface, so you should not expect the curve shown in the debug view in Pro Tools to exactly match what would appear to users. After performing early prototyping of your curve data using the Test\+Get\+Curve\+Data Digi\+Option you are strongly encouraged to use either the S6 Surfulator software or the \mbox{\hyperlink{a00849_subsubsection__avid_ptcontrol}{Pro Tools $\vert$ Control}} app to test and refine the plug-\/in\textquotesingle{}s curve data in a real-\/world environment.
\end{DoxyWarning}
For more information about graph curves see \mbox{\hyperlink{a00827}{EQ and Dynamics Curve Displays}} .

\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000015}{Host Compatibility Notes}}]Supported in Pro Tools 12 and higher.\end{DoxyRefDesc}
...
\begin{DoxyNote}{Note}
This option is currently non-\/functional for AAX plug-\/ins Pro Tools. See \mbox{\hyperlink{a00862_PTSW-188653}{PTSW-\/188653 / PT-\/218451}}
\end{DoxyNote}
...
\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000016}{Host Compatibility Notes}}]Supported in Pro Tools 12 and higher.\end{DoxyRefDesc}
...
Note that Pro Tools asserts may be triggered by your plug-\/ins; you should always investigate any assert that you see to determine whether it is being caused by a plug-\/in. If you need information about any Pro Tools asserts, post a question here on the \mbox{\hyperlink{a00868}{AAX}} developer forums or write to us at \href{mailto:devservices@avid.com}{\texttt{ devservices@avid.\+com}} and we will be happy to help. 


\item  {\ttfamily Test\+Plug\+In\+Descriptions 0}

Use this Digi\+Option to toggle the plug-\/in description validation check in Pro Tools developer builds. Developer builds beginning in Pro Tools 12.\+8.\+2 will check plug-\/in description information when the plug-\/in is loaded and will present a warning dialog if the check fails. See \mbox{\hyperlink{a00811_describe_validation}{Describe Validation}} section in the \mbox{\hyperlink{a00811}{Description callback}} page for more information.

\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000017}{Host Compatibility Notes}}]Supported in Pro Tools 12.\+6 and higher.\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000018}{Host Compatibility Notes}}]Supported in Pro Tools 12.\+8.\+2 and higher.\end{DoxyRefDesc}
...
Enable the Console window in Pro Tools which displays the application\textquotesingle{}s \mbox{\hyperlink{a00850}{Digi\+Trace}} output in a live stream.

\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00801__compatibility_notes000019}{Host Compatibility Notes}}]Supported in Pro Tools 2019.\+XX and higher. Also supported (and enabled by default) in Pro Tools developer builds beginning with Pro Tools 2019.\+6.\end{DoxyRefDesc}
...
\end{DoxyItemize}
 ...
 \hypertarget{a00846_aax_pro_tools_guide_07_compatibility_notes}{}\doxysubsection{Compatibility Notes}\label{a00846_aax_pro_tools_guide_07_compatibility_notes}
{\itshape See \mbox{\hyperlink{a00861}{Host Support}} and \mbox{\hyperlink{a00862_knownissues_ptsw}{Known Issues in Pro Tools}} for additional details regarding Pro Tools compatibility }

\hypertarget{a00846_subsection__changing_parameter_names}{}\doxysubsubsection{Changing parameter names}\label{a00846_subsection__changing_parameter_names}
Name changes for automatable plug-\/in parameters are only supported starting in Pro Tools 11.\+1. This applies both to changing a parameter Name at runtime with \mbox{\hyperlink{a02145_a480e9947cdaee6f26ca2bbaeb9de56b2}{AAX\+\_\+\+IParameter\+::\+Set\+Name()}} and to changing a parameter Name between different versions of the plug-\/in.
...
\begin{center}
\leavevmode
\includegraphics[width=297pt]{a00846}
\end{center}
\end{figure}
