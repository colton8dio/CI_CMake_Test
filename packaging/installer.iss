...
OutputBaseFilename=CI_CMake_Test_setup
Compression=lzma
...
[Files]
Source: "{src}..\Builds\CI_CMake_Test_artefacts\Release\Standalone\CI_CMake_Test.exe\*.*"; DestDir: "{code:GetDir|0}"; Flags: ignoreversion
Source: "{src}..\Builds\CI_CMake_Test_artefacts\Release\VST3\CI_CMake_Test.vst3\*.*"; DestDir: "{autocf}\VST3"; Flags: ignoreversion
